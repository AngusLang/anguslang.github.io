...
const tab_open = function() {
  ...
  tab_container.style.height = '40%';
  tab.style.display = 'inline-block';
  tab_toggle.style.display = 'none';
}

const tab_close = function() {
  if (!isMobile) return;
  tab_container.style.width = '40px';
  tab_container.style.height = '40px';
  tab_toggle.style.display = 'inline-block';
  tab.style.display = 'none';
}

tab_toggle.onclick = tab_open;
